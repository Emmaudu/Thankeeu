-- Blog post: "50 Leaving Card Messages" — high-intent SEO content.
-- Fixed version: correct column names (is_featured not featured),
-- author_name included, content uses straight quotes to avoid encoding
-- issues, ON CONFLICT uses DO UPDATE safely.
--
...
<p>The good news: a leaving card message does not have to be long. It just has to feel genuine. Here are 50 messages you can use, adapt, or treat as a starting point — organised by tone and relationship so you can find the right one fast.</p>
<hr/>
...
<p>Takes about 2 minutes to set up. Free to create.</p>
  ...
  'Colleagues gathered around a laptop to sign an online leaving card',
