...
CREATE TABLE cards (
  ...
  font_style TEXT DEFAULT 'elegant' CHECK (font_style IN ('elegant', 'calligraphy', 'handwritten', 'classic', 'modern')),
...
CREATE TABLE messages (
  ...
  font_style TEXT DEFAULT 'handwritten' CHECK (font_style IN ('elegant', 'calligraphy', 'handwritten', 'classic', 'modern')),
  media_url TEXT,
