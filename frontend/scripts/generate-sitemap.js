...
const STATIC_LASTMOD = {
  ...
  '/send-money-greeting-card':   '2026-09-04',
  '/cards/leaving-card':         '2026-08-31',
  '/cards/leaving-card/gallery': '2026-08-31',
  '/cards/create':          '2026-08-31',
  '/sample':                '2026-06-27',
  '/faq':                   '2026-06-27',
  '/policy':                '2026-06-27',
  ...
  '/thankeeu-vs-thankbox':  '2026-07-17',
  '/thankeeu-vs-kudoboard': '2026-07-17',
  '/thankeeu-vs-thankbox-vs-kudoboard': '2026-07-17',
  '/leaving-cards-uk':      '2026-07-17',
  '/cards/sympathy':        '2026-07-17',
  '/occasions/birthday':    '2026-07-17',
  '/occasions/farewell':    '2026-07-17',
  '/signup':                '2026-06-27',
...
const STATIC_PAGES = [
  ...
  { loc: '/send-money-greeting-card',   changefreq: 'monthly', priority: '0.9', hreflang: true },
  { loc: '/cards/leaving-card',         changefreq: 'monthly', priority: '0.9', hreflang: true },
  { loc: '/cards/leaving-card/gallery', changefreq: 'monthly', priority: '0.7', hreflang: true },
  { loc: '/cards/create',               changefreq: 'monthly', priority: '0.8', hreflang: true },
  ...
  { loc: '/memory-movie',        changefreq: 'monthly', priority: '0.9', hreflang: true },
  { loc: '/live-memory-wall',    changefreq: 'monthly', priority: '0.9', hreflang: true },
  ...
  { loc: '/pov-alternative',        changefreq: 'monthly', priority: '0.9', hreflang: true },
  { loc: '/guestcam-alternative',   changefreq: 'monthly', priority: '0.9', hreflang: true },
  { loc: '/wedding-photo-sharing-app',     changefreq: 'monthly', priority: '0.9', hreflang: true },
  { loc: '/wedding-photo-upload-app',      changefreq: 'monthly', priority: '0.8', hreflang: true },
  { loc: '/qr-code-for-wedding-photos',    changefreq: 'monthly', priority: '0.9', hreflang: true },
  { loc: '/collect-wedding-guest-photos',  changefreq: 'monthly', priority: '0.9', hreflang: true },
  { loc: '/digital-wedding-guest-book',    changefreq: 'monthly', priority: '0.9', hreflang: true },
  { loc: '/wedding-memory-book',           changefreq: 'monthly', priority: '0.8', hreflang: true },
  { loc: '/wedding-photo-gallery',         changefreq: 'monthly', priority: '0.8', hreflang: true },
  { loc: '/wedding-photo-album-online',    changefreq: 'monthly', priority: '0.8', hreflang: true },
  { loc: '/best-wedding-photo-sharing-app',changefreq: 'monthly', priority: '0.9', hreflang: true },
  { loc: '/wedding-guest-photo-collection',changefreq: 'monthly', priority: '0.8', hreflang: true },
  { loc: '/online-wedding-guestbook',      changefreq: 'monthly', priority: '0.9', hreflang: true },
  { loc: '/wedding-video-message-book',    changefreq: 'monthly', priority: '0.8', hreflang: true },
  { loc: '/wedding-voice-note-guest-book', changefreq: 'monthly', priority: '0.8', hreflang: true },
  { loc: '/wedding-cash-gift-platform',    changefreq: 'monthly', priority: '0.9', hreflang: true },
  { loc: '/wedding-group-card',            changefreq: 'monthly', priority: '0.9', hreflang: true },
  { loc: '/uk-wedding-photo-sharing',      changefreq: 'monthly', priority: '0.9', hreflang: 'en-GB' },
  { loc: '/usa-wedding-photo-sharing',     changefreq: 'monthly', priority: '0.9', hreflang: 'en-US' },
  { loc: '/online-group-card',             changefreq: 'monthly', priority: '0.9', hreflang: true },
  { loc: '/leaving-cards-uk',        changefreq: 'monthly', priority: '0.9', hreflang: 'en-GB' },
  { loc: '/birthday-cards-uk',       changefreq: 'monthly', priority: '0.9', hreflang: 'en-GB' },
  { loc: '/retirement-cards-uk',     changefreq: 'monthly', priority: '0.8', hreflang: 'en-GB' },
  { loc: '/get-well-soon-cards-uk',  changefreq: 'monthly', priority: '0.8', hreflang: 'en-GB' },
  { loc: '/occasions/birthday',          changefreq: 'monthly', priority: '0.8', hreflang: true },
  { loc: '/occasions/staff-appreciation',changefreq: 'monthly', priority: '0.7', hreflang: true },
