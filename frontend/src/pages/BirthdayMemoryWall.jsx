...
<div className="grid sm:grid-cols-3 gap-5"> {[ { emoji: '', title: 'Heartfelt birthday messages', desc: 'Every guest writes their own personal message — with photos, voice notes, GIFs and a gift contribution. Collected in a beautiful digital card.' }, { emoji: '', title: 'Live birthday photo wall', desc: 'Guests upload photos all day — from the party, from home, from across the country. Every upload appears on the wall in real time.' }, { emoji: '', title: 'Auto Birthday Memory Movie™', desc: 'After the birthday, every message and photo becomes a cinematic birthday movie the celebrant keeps and watches for years.' }, ].map(({ emoji, title, desc }) => ( <div key={title} className="text-center p-6 rounded-2xl bg-purple-50 border border-purple-100">
...
<div className="space-y-4"> {[ { n: '1', title: 'Create the birthday card and enable Live Memory Wall™', body: 'Choose birthday, enter their name, pick a delivery time — and turn on the Memory Wall. Done.' }, { n: '2', title: 'Share the link before the party', body: 'Send the signing link to family and friends. They upload photos from the venue, from their homes, and from wherever they are. You can also display the QR code at the party venue.' }, { n: '3', title: 'Watch photos roll in all day — live on any screen', body: 'Open the Memory Wall on a TV or laptop at the party. Every uploaded photo appears in real time. The celebrant watches their wall grow throughout the day.' }, { n: '4', title: 'After the birthday, enjoy the Memory Movie™', body: 'Thankeeu auto-assembles every message, photo and video into a cinematic birthday film. The most emotional thing they\'ll watch all year.' }, ].map(({ n, title, body }) => ( <div key={n} className="flex gap-4 bg-white rounded-2xl p-5 border border-purple-100 shadow-sm">
...
<div className="grid sm:grid-cols-2 gap-6"> {[ { emoji: '', title: 'No app. No account. No friction.', body: 'The reason photos die in people\'s camera rolls: nobody wants to download another app. Thankeeu works directly in any phone browser — one tap from the link and they\'re uploading. That\'s why participation is genuinely high.' }, { emoji: '', title: 'Works on every phone and device', body: 'iPhone, Android, or any smartphone with a browser — Thankeeu works for every guest, every generation. One link, no compatibility issues.' }, { emoji: '', title: 'Friends and family anywhere can contribute', body: 'Someone on the other side of the country can upload a throwback photo or send a video message. The Memory Wall collects every perspective, no matter the distance.' }, { emoji: '', title: 'Photos + gift in the same link', body: 'Instead of a separate payment link for the birthday gift, Thankeeu collects photos and gift contributions together. One link does everything.' }, ].map(({ emoji, title, body }) => ( <div key={title} className="p-6 rounded-2xl bg-purple-50 border border-purple-100">
