...
export default function BookDemo() {
 ...
 <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl text-xs font-bold mb-6"
 ...
 <span className="text-xs bg-emerald-100 text-emerald-700 font-bold px-2 py-1 rounded-xl">32 signed</span>
 </div>
 ...
 <div className="ml-auto flex items-center gap-1 px-2.5 py-1 rounded-xl text-xs font-bold"
 ...
 <div className="absolute -top-8 -right-8 w-32 h-32 rounded-xl pointer-events-none"
 ...
 <div className="ml-auto flex items-center gap-1 px-2.5 py-1 rounded-xl text-xs font-bold" style={{ background:'#d1fae5', color:'#065f46' }}>
 ...
 <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-xl text-xs font-bold mb-3"
