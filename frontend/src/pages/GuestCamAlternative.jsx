...
const COMPETITOR = 'GuestCam';
const SLUG = '/guestcam-alternative';
...
export default function GuestCamAlternative() {
  useSEO({
    title: `The Best ${COMPETITOR} Alternative for Wedding Guest Photo Sharing | Thankeeu`,
    description: 'Looking for a GuestCam alternative? Thankeeu does more — collect photos, videos, voice notes, GIFs, wishes and cash gifts from every wedding guest via QR code. No app. Memory Movie included. Works in 30+ currencies.',
    keywords: 'guestcam alternative, better than guestcam, guestcam vs thankeeu, wedding photo sharing app alternative, collect guest wedding photos, wedding memory wall',
    canonical: SLUG,
    locale: 'en',
    jsonLd,
  });
      ...
      <section className="py-14 px-4 bg-white" id="why-alternative">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              { icon: 'Heart', title: 'They want memories, not just camera rolls',
                body: 'GuestCam collects wedding photos from guests\' cameras. Thankeeu collects the memories behind the photos — the written wishes, the voice blessings, the GIF messages, the pooled cash gift. A complete record of everyone who was there and what they felt.' },
              { icon: 'Gift', title: 'They want cash gifts pooled automatically',
                body: 'A cash gift is the most practical wedding gift. Thankeeu\'s gift pot lets every guest contribute any amount — in their own currency — alongside uploading photos. Everything pools automatically with zero coordination required.' },
              { icon: 'Film', title: 'They want a cinematic keepsake',
                body: 'GuestCam gives you a photo collection. Thankeeu gives you a Memory Movie™ — auto-assembled from every photo, video, message and voice note, set to music, ready to watch on the wedding night and every anniversary after.' },
              { icon: 'Globe', title: 'They need WhatsApp-first distribution',
                body: 'In Nigeria, the UK diaspora, and across Africa, WhatsApp is how invitations are sent. Thankeeu generates a WhatsApp-ready link that works on any phone without an app. Perfect for the reality of how modern families communicate.' },
              { icon: 'Mic', title: 'They want voice blessings from every generation',
                body: 'From the youngest flower girl to the oldest grandmother in attendance, everyone can record a voice blessing directly in their phone browser. These recordings are archived permanently alongside every other contribution.' },
              { icon: 'Calendar', title: 'They want the memory to grow over time',
                body: 'A GuestCam photo collection is frozen at the wedding day. A Thankeeu memory wall is alive — couples return on each anniversary, add new photos, record new messages, and build an archive that spans the full life of the marriage.' },
            ].map(({ icon, title, body }) => (
