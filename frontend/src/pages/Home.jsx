...
const STEPS = [
  ...
  { num: '03', icon: '🎁', title: 'Collect a gift together',desc: 'Anyone can chip in from ₦500 into a shared gift pot. No awkward collecting.' },
  { num: '04', icon: '💌', title: 'Deliver the surprise',   desc: "Schedule delivery or send instantly. One beautiful card with everyone's love." },
];

const TESTIMONIALS = [
  { name: 'Adaeze O.', location: 'Lagos',         text: "My team used Thankeeu for our colleague's farewell and she literally cried. Everyone contributed to a spa voucher. So easy!", av: 'AO' },
  { name: 'Emeka T.',  location: 'Abuja',          text: "Organised my girlfriend's birthday card from London. 22 people signed and we raised ₦80,000 for her. She was shocked!",     av: 'ET' },
  { name: 'Kemi B.',   location: 'Port Harcourt',  text: 'Finally a Nigerian platform for this! No more Google forms and chasing people for money. Paystack makes it seamless.',       av: 'KB' },
];
...
const DemoModal = ({ onClose }) => {
  useSEO({
    ...
    description: "Nigeria's #1 group card and gift platform. Create beautiful online group cards, collect heartfelt messages and send Paystack gift pots. Birthdays, farewells, promotions, new hires and more. Made for Nigeria 🇳🇬",
    canonical:   '/',
    keywords:    'group card nigeria, birthday card online nigeria, farewell card, group gift paystack, thankeeu, team celebration nigeria, online group card, office birthday card nigeria, group greeting card',
    jsonLd:      [
      ...
      SCHEMAS.faqPage([
        ...
        { q: 'How much does Thankeeu cost?',          a: 'Creating a card and collecting messages is completely free. Sending the card to the recipient costs ₦1,500 per card, or ₦5,000 for a pack of 5 cards (saving ₦2,500).' },
        ...
        { q: 'Is Thankeeu available for companies?',  a: 'Yes! Thankeeu for Teams lets companies automate birthday cards, farewell cards, promotions, new hire welcomes, and more for their entire team. Connect SeamlessHR, BambooHR, Zoho People, WorkPay or SAP SuccessFactors for automatic sync. Starts at ₦20,000/month.' },
        { q: 'Which payment methods are supported?',  a: 'Thankeeu uses Paystack, which supports all Nigerian cards (Visa, Mastercard, Verve), bank transfers, USSD (*737#, *822# etc.), and mobile money.' },
        { q: 'Can people outside Nigeria use Thankeeu?', a: 'Yes, Nigerians in the diaspora can sign cards and contribute to gift pots using international cards. The platform is optimised for Nigeria but accessible globally.' },
        { q: 'What payment methods are supported?', a: 'All Nigerian debit and credit cards, bank transfer, USSD, and mobile money via Paystack.' },
        { q: 'Does Thankeeu work for companies?',   a: 'Yes. Thankeeu for Teams automates birthdays, farewells, new hires, promotions and more for your entire team. From ₦20,000/month.' },
      ]),
    ],
  });
            ...
            <form onSubmit={handleSubmit} className="px-6 py-5 space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input className="input" placeholder="Zenith Bank Nigeria" value={form.company_name} onChange={e => set('company_name', e.target.value)} required />
                </div>
                <div>
    ...
    <div className="min-h-screen overflow-x-hidden">
      ...
      <section className="gradient-hero pt-12 pb-16 md:pt-20 md:pb-24 lg:pt-28 lg:pb-32">
        <div className="section-container text-center">
          ...
          <p className="text-xs sm:text-sm text-gray-500 mt-4">No subscription for personal cards · Paystack-powered · Made for Nigeria</p>
          ...
          <div className="mt-12 md:mt-16 mx-auto max-w-sm sm:max-w-md md:max-w-2xl px-2 sm:px-0">
            <div className="bg-white rounded-2xl md:rounded-3xl shadow-2xl p-4 md:p-6 border border-gray-100">
              ...
              <div className="bg-green-50 rounded-xl p-3 flex items-center justify-between">
                ...
                <span className="text-base md:text-lg font-bold text-green-700">₦92,500</span>
              </div>
            </div>
          </div>
        </div>
          ...
          <div className="bg-gradient-to-br from-primary-50 via-white to-pink-50 rounded-2xl md:rounded-3xl p-6 md:p-10 lg:p-12 border border-primary-100">
            <div className="grid md:grid-cols-2 gap-8 md:gap-10 items-center">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-3">₦20,000/month · Unlimited employees · Cancel anytime</p>
              </div>
      ...
      <section className="py-12 md:py-16 bg-primary-400">
        <div className="section-container">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 text-center text-white">
            {[['10,000+','Cards created'],['500,000+','Messages sent'],['₦50M+','Gifts collected'],['4.9★','User rating']].map(([val, label]) => (
              <div key={label}>
      ...
      <section className="section-py bg-white">
        <div className="section-container">
          <div className="text-center mb-8 md:mb-12">
            <h2 className="text-2xl md:text-4xl text-gray-900 mb-3 md:mb-4">Nigerians love Thankeeu</h2>
          </div>
        ...
        <div className="section-container">
          <div className="max-w-2xl mx-auto text-center">
            ...
            <p className="text-gray-400 text-sm md:text-base mb-3 leading-relaxed">
              See how companies across Nigeria use Thankeeu for Teams to celebrate their employees — birthdays, farewells, promotions, new hires and more. Fully automated.
            </p>
        ...
        <div className="section-container">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 md:gap-6">
            <div className="gradient-hero rounded-2xl md:rounded-3xl p-6 md:p-8 text-center border border-primary-100">
              ...
              <p className="text-gray-600 text-sm mb-5 md:mb-6 leading-relaxed">Create a group card for a friend, family member, or colleague. Free to start, ₦1,500 to send.</p>
