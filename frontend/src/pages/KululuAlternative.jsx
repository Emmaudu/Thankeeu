...
const COMPETITOR = 'Kululu';
const SLUG = '/kululu-alternative';
...
export default function KululuAlternative() {
  useSEO({
    title: `The Best ${COMPETITOR} Alternative for Wedding Guest Photo Sharing | Thankeeu`,
    description: 'Looking for a Kululu alternative? Thankeeu goes beyond wedding photo uploads — collect voice notes, videos, written wishes and cash gifts in one place. Auto Memory Movie, permanent storage, NGN and GBP supported.',
    keywords: 'kululu alternative, better than kululu, kululu vs thankeeu, wedding photo app alternative, wedding memory platform, collect wedding photos no app',
    canonical: SLUG,
    locale: 'en',
    jsonLd,
  });
      ...
      <section className="py-14 px-4 bg-white" id="why-alternative">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="grid sm:grid-cols-2 gap-5">
            {[
              { icon: 'Heart', title: 'They want the full emotional range captured',
                body: 'Kululu collects photos at the event. Thankeeu captures the emotional depth of a wedding day — the grandmother\'s voice blessing, the best friend\'s tearful written message, the GIF from the maid of honour. Photos record events; Thankeeu records relationships.' },
              { icon: 'Gift', title: 'They want gifting integrated, not separate',
                body: 'Running a separate WhatsApp group for cash gifts creates confusion and missed contributions. Thankeeu\'s built-in gift pot handles everything — pooled contributions, currency conversion, and direct withdrawal to the couple\'s bank account.' },
              { icon: 'Film', title: 'They want a Memory Movie without editing skills',
                body: 'Most couples have no video editing experience. Thankeeu automatically assembles every photo, video, message and voice note into a cinematic Memory Movie™ with background music. Zero effort. Professional result.' },
              { icon: 'Globe', title: 'They need NGN and African currency support',
                body: 'For Nigerian weddings, Kululu\'s lack of Naira support is a dealbreaker. Thankeeu accepts Naira payments via Flutterwave — every Nigerian bank card, USSD code, and mobile money transfer works seamlessly.' },
              { icon: 'Users', title: 'They want guest engagement beyond uploading',
                body: 'Guests who attend a wedding want to feel like participants, not just content providers. Thankeeu lets guests leave written wishes, voice blessings, GIF reactions, and cash contributions — making every guest a full contributor to the memory.' },
              { icon: 'Calendar', title: 'They want anniversary memories built in',
                body: 'The wedding day is the beginning. Thankeeu is designed for the lifetime — couples return every anniversary, add new memories, and build a living archive that captures the whole marriage, not just the ceremony.' },
            ].map(({ icon, title, body }) => (
