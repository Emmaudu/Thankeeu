...
]; const OCCASIONS = [ { emoji: '', label: 'Birthdays' }, { emoji: '', label: 'Farewell & Leaving' }, { emoji: '', label: 'Retirement' }, { emoji: '', label: 'Graduation' }, { emoji: '', label: 'Engagements' }, { emoji: '', label: 'New Baby' }, { emoji: '', label: 'New Home' }, { emoji: '', label: 'Promotions' },
...
<div className="grid grid-cols-2 sm:grid-cols-4 gap-4 my-10"> {[ { emoji: '', n: '80', label: 'birthday wishes' }, { emoji: '', n: '50', label: 'photos' }, { emoji: '', n: '12', label: 'videos' }, { emoji: '', n: '20', label: 'voice notes' }, ].map(({ emoji, n, label }) => ( <div key={label} className="rounded-2xl bg-purple-50 border border-purple-100 p-5">
...
{emoji && <span>{emoji}</span>}{label} </Link> ))} </div>
</div>
