...
const Signup = () => {
  useSEO({
    ...
    description: 'Sign up free and create your first group card in 2 minutes. Collect messages from everyone and send meaningful gifts with Paystack. No credit card required.',
    canonical:   '/signup',
    jsonLd:      [
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input type="text" className="input" placeholder="Amaka Okafor" required
