...
<div className="grid sm:grid-cols-2 gap-6"> {[ { emoji: '', title: 'No app. No account. No friction.', body: 'The #1 reason guests don\'t share photos is that they can\'t be bothered with sign-ups. Thankeeu removes every barrier — guests scan the QR code and are uploading in under 10 seconds. Works on every phone, for guests of every age.' }, { emoji: '', title: 'Messages + photos + gift, not just photos', body: 'Wedtrove only collects photos. Thankeeu collects photos AND heartfelt messages, voice notes, and wedding gift contributions — all in one card, all delivered to the couple together.' }, { emoji: '', title: 'Live photo wall on your venue screens', body: 'Open the Memory Wall on a TV or projector at your reception. Guest photos appear the moment they\'re uploaded — a live slideshow your whole wedding watches together in real time.' }, { emoji: '', title: 'Automatic Wedding Memory Movie™', body: 'After the celebration, Thankeeu assembles every message, photo and video into a cinematic Memory Movie. A wedding film made by everyone who loves you — not just the videographer.' }, { emoji: '', title: 'Full quality, permanently preserved', body: 'Every photo uploads at original resolution. No compression. No 30-day expiry. The wall lives forever — open it on your first anniversary and relive every moment.' }, { emoji: '', title: 'Works for guests anywhere in the world', body: 'Friends across the country or overseas can upload photos and write messages from anywhere. The Memory Wall captures every perspective, no matter the distance.' }, ].map(({ emoji, title, body }) => ( <div key={title} className="p-6 rounded-2xl bg-purple-50 border border-purple-100">
...
<tbody className="divide-y divide-purple-50"> {[ ['QR code for guest photos', '', ''], ['No app or account for guests', '', ''], ['Unlimited guests', '', ''], ['Full-quality photo uploads', '', ''], ['Personal heartfelt messages', '', ''], ['Voice notes from guests', '', ''], ['Wedding gift pot', '', ''], ['Auto Memory Movie™ from photos', '', ''], ['Photo + card in one delivery', '', ''], ['Multi-currency payments', '', ''], ].map(([f, a, b]) => ( <tr key={f}>
