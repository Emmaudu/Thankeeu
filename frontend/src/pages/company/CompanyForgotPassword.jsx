    ...
    <div className="min-h-screen gradient-hero flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <h1 className="font-display text-3xl font-semibold text-gray-900 mb-2">Reset company password</h1>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8 border border-gray-100">
          {sent ? (
            <div className="text-center py-4">
              ...
              <p className="text-gray-500 text-sm mb-6">If <strong>{email}</strong> has a company account, a reset link has been sent.</p>
