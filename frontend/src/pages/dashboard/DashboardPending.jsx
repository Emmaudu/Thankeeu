    ...
    <DashboardLayout title="Pending to Sign ✍️" subtitle="Cards you've been invited to sign">
      {loading ? (
        ...
        <div className="space-y-3">
          {items.map(item=>(
            <div key={item.id} className="rounded-2xl border-2 p-4 flex items-center gap-4 hover:shadow-sm transition-all" style={{background:'#fff',borderColor:'#EDE9FF'}}>
