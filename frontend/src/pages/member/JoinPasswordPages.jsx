      ...
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          <Link to="/" className="inline-flex items-center gap-2 mb-4">
            ...
            <span className="font-display font-semibold text-2xl text-warm-900">Thankeeu</span>
          </Link>
          ...
          <h1 className="font-display text-2xl font-semibold text-warm-900 mb-1">Reset password</h1>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-7 border border-purple-100">
          {sent ? (
            <div className="text-center py-4">
              ...
              <p className="text-warm-500 text-sm mb-5">If <strong>{email}</strong> has an account, a reset link has been sent.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <p className="text-center text-sm text-warm-500"><Link to="/member/login" className="text-primary-400 font-medium">← Back to sign in</Link></p>
            </form>
          )}
        </div>
      </div>
    ...
    <div className="min-h-screen"><Navbar /><div className="flex items-center justify-center p-4 py-12 md:py-20">
      <div className="w-full max-w-md">
        <div className="text-center mb-8">
          ...
          <div className="inline-flex items-center gap-2 bg-primary-50 text-primary-600 text-xs font-medium px-3 py-1.5 rounded-full mb-3">👥 Team account</div>
          <h1 className="font-display text-2xl font-semibold text-warm-900 mb-1">Set new password</h1>
        </div>
        <div className="bg-white rounded-3xl shadow-xl p-7 border border-purple-100">
          {done ? (
            <div className="text-center py-4">
