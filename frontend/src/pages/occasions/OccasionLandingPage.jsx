...
const OCCASIONS = {
  birthday: {
    ...
    whySection: {
      ...
      points: [
        ...
        { icon: '🎙️', title: 'Voice Notes That Give Goosebumps', body: 'This is what sets Thankeeu apart. A recorded voice message from a colleague or loved one lands differently. Nigerians are sending voice notes daily — now they can do it on a birthday card.' },
  ...
  graduation: {
    ...
    heroBullets: [
      ...
      '🎙️ Parents record their congratulations in their own voice — a keepsake forever',
    ],
    whySection: {
      ...
      points: [
        ...
        { icon: '🎙️', title: 'Mum\'s Voice. Grandpa\'s Prayer. Forever.', body: 'The voice note feature is the most emotional part of a Thankeeu graduation card. When parents, grandparents, and siblings record personal messages in their voice — that is a gift that cannot be bought in any store.' },
  ...
  'new-baby': {
    ...
    faqs: [
      ...
      { q: 'What do you write in a new baby card for a Nigerian colleague?', a: '"Congratulations on your newest blessing! May this child bring you immeasurable joy and fulfil every prayer. 🙏❤️" — Nigerian warmth always includes a prayer. Make it personal by adding the baby\'s name if you know it.' },
    ...
    <div className="min-h-screen" style={{ background: d.bg }}>
      ...
      <section className="max-w-5xl mx-auto px-4 pb-16">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {[
            ...
            ['🎙️', 'Voice notes', 'Record audio directly from any phone. Heard in their voice — the most emotional feature we have.'],
      ...
      <section className="max-w-5xl mx-auto px-4 pb-16">
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          {[
            { step: '1', icon: '✏️', title: 'Create the card', body: 'Choose the occasion, add the recipient\'s name, and write your message. Takes 2 minutes.' },
